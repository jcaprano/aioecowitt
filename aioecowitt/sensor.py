...
SENSOR_MAP: dict[str, EcoWittMapping] = {
    ...
    # WH52 3-in-1 soil sensor (moisture / temperature / EC). Channels 1-16,
    # shared channel space with the WH51 soil moisture sensor.
    ...
    "soil_ec_hum_ad1": EcoWittMapping(
        "Soil AD 1", EcoWittSensorTypes.SOIL_RAWADC
    ),
    "soil_ec_hum_ad2": EcoWittMapping(
        "Soil AD 2", EcoWittSensorTypes.SOIL_RAWADC
    ),
    "soil_ec_hum_ad3": EcoWittMapping(
        "Soil AD 3", EcoWittSensorTypes.SOIL_RAWADC
    ),
    "soil_ec_hum_ad4": EcoWittMapping(
        "Soil AD 4", EcoWittSensorTypes.SOIL_RAWADC
    ),
    "soil_ec_hum_ad5": EcoWittMapping(
        "Soil AD 5", EcoWittSensorTypes.SOIL_RAWADC
    ),
    "soil_ec_hum_ad6": EcoWittMapping(
        "Soil AD 6", EcoWittSensorTypes.SOIL_RAWADC
    ),
    "soil_ec_hum_ad7": EcoWittMapping(
        "Soil AD 7", EcoWittSensorTypes.SOIL_RAWADC
    ),
    "soil_ec_hum_ad8": EcoWittMapping(
        "Soil AD 8", EcoWittSensorTypes.SOIL_RAWADC
    ),
    "soil_ec_hum_ad9": EcoWittMapping(
        "Soil AD 9", EcoWittSensorTypes.SOIL_RAWADC
    ),
    "soil_ec_hum_ad10": EcoWittMapping(
        "Soil AD 10", EcoWittSensorTypes.SOIL_RAWADC
    ),
    "soil_ec_hum_ad11": EcoWittMapping(
        "Soil AD 11", EcoWittSensorTypes.SOIL_RAWADC
    ),
    "soil_ec_hum_ad12": EcoWittMapping(
        "Soil AD 12", EcoWittSensorTypes.SOIL_RAWADC
    ),
    "soil_ec_hum_ad13": EcoWittMapping(
        "Soil AD 13", EcoWittSensorTypes.SOIL_RAWADC
    ),
    "soil_ec_hum_ad14": EcoWittMapping(
        "Soil AD 14", EcoWittSensorTypes.SOIL_RAWADC
    ),
    "soil_ec_hum_ad15": EcoWittMapping(
        "Soil AD 15", EcoWittSensorTypes.SOIL_RAWADC
    ),
    "soil_ec_hum_ad16": EcoWittMapping(
        "Soil AD 16", EcoWittSensorTypes.SOIL_RAWADC
    ),
    ...
    "soil_ec1": EcoWittMapping(
        "Soil Conductivity 1", EcoWittSensorTypes.CONDUCTIVITY
    ),
    "soil_ec2": EcoWittMapping(
        "Soil Conductivity 2", EcoWittSensorTypes.CONDUCTIVITY
    ),
    "soil_ec3": EcoWittMapping(
        "Soil Conductivity 3", EcoWittSensorTypes.CONDUCTIVITY
    ),
    "soil_ec4": EcoWittMapping(
        "Soil Conductivity 4", EcoWittSensorTypes.CONDUCTIVITY
    ),
    "soil_ec5": EcoWittMapping(
        "Soil Conductivity 5", EcoWittSensorTypes.CONDUCTIVITY
    ),
    "soil_ec6": EcoWittMapping(
        "Soil Conductivity 6", EcoWittSensorTypes.CONDUCTIVITY
    ),
    "soil_ec7": EcoWittMapping(
        "Soil Conductivity 7", EcoWittSensorTypes.CONDUCTIVITY
    ),
    "soil_ec8": EcoWittMapping(
        "Soil Conductivity 8", EcoWittSensorTypes.CONDUCTIVITY
    ),
    "soil_ec9": EcoWittMapping(
        "Soil Conductivity 9", EcoWittSensorTypes.CONDUCTIVITY
    ),
    "soil_ec10": EcoWittMapping(
        "Soil Conductivity 10", EcoWittSensorTypes.CONDUCTIVITY
    ),
    "soil_ec11": EcoWittMapping(
        "Soil Conductivity 11", EcoWittSensorTypes.CONDUCTIVITY
    ),
    "soil_ec12": EcoWittMapping(
        "Soil Conductivity 12", EcoWittSensorTypes.CONDUCTIVITY
    ),
    "soil_ec13": EcoWittMapping(
        "Soil Conductivity 13", EcoWittSensorTypes.CONDUCTIVITY
    ),
    "soil_ec14": EcoWittMapping(
        "Soil Conductivity 14", EcoWittSensorTypes.CONDUCTIVITY
    ),
    "soil_ec15": EcoWittMapping(
        "Soil Conductivity 15", EcoWittSensorTypes.CONDUCTIVITY
    ),
    "soil_ec16": EcoWittMapping(
        "Soil Conductivity 16", EcoWittSensorTypes.CONDUCTIVITY
    ),
    "soil_ec_ad1": EcoWittMapping(
        "Soil Conductivity AD 1", EcoWittSensorTypes.SOIL_RAWADC
    ),
    "soil_ec_ad2": EcoWittMapping(
        "Soil Conductivity AD 2", EcoWittSensorTypes.SOIL_RAWADC
    ),
    "soil_ec_ad3": EcoWittMapping(
        "Soil Conductivity AD 3", EcoWittSensorTypes.SOIL_RAWADC
    ),
    "soil_ec_ad4": EcoWittMapping(
        "Soil Conductivity AD 4", EcoWittSensorTypes.SOIL_RAWADC
    ),
    "soil_ec_ad5": EcoWittMapping(
        "Soil Conductivity AD 5", EcoWittSensorTypes.SOIL_RAWADC
    ),
    "soil_ec_ad6": EcoWittMapping(
        "Soil Conductivity AD 6", EcoWittSensorTypes.SOIL_RAWADC
    ),
    "soil_ec_ad7": EcoWittMapping(
        "Soil Conductivity AD 7", EcoWittSensorTypes.SOIL_RAWADC
    ),
    "soil_ec_ad8": EcoWittMapping(
        "Soil Conductivity AD 8", EcoWittSensorTypes.SOIL_RAWADC
    ),
    "soil_ec_ad9": EcoWittMapping(
        "Soil Conductivity AD 9", EcoWittSensorTypes.SOIL_RAWADC
    ),
    "soil_ec_ad10": EcoWittMapping(
        "Soil Conductivity AD 10", EcoWittSensorTypes.SOIL_RAWADC
    ),
    "soil_ec_ad11": EcoWittMapping(
        "Soil Conductivity AD 11", EcoWittSensorTypes.SOIL_RAWADC
    ),
    "soil_ec_ad12": EcoWittMapping(
        "Soil Conductivity AD 12", EcoWittSensorTypes.SOIL_RAWADC
    ),
    "soil_ec_ad13": EcoWittMapping(
        "Soil Conductivity AD 13", EcoWittSensorTypes.SOIL_RAWADC
    ),
    "soil_ec_ad14": EcoWittMapping(
        "Soil Conductivity AD 14", EcoWittSensorTypes.SOIL_RAWADC
    ),
    "soil_ec_ad15": EcoWittMapping(
        "Soil Conductivity AD 15", EcoWittSensorTypes.SOIL_RAWADC
    ),
    "soil_ec_ad16": EcoWittMapping(
        "Soil Conductivity AD 16", EcoWittSensorTypes.SOIL_RAWADC
    ),
